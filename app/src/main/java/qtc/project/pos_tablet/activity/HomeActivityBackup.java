...
import qtc.project.pos_tablet.dialog.FeedbackRatingDialog;
import qtc.project.pos_tablet.event.AleartSignedEvent;
import qtc.project.pos_tablet.event.AlertCheckRolePermissionEvent;
import qtc.project.pos_tablet.event.AlertCheckTaskEvent;
import qtc.project.pos_tablet.event.AlertCheckUserRolePermissionEvent;
import qtc.project.pos_tablet.event.KeyboardInEvent;
import qtc.project.pos_tablet.event.KeyboardOutEvent;
import qtc.project.pos_tablet.event.ReloadMenuBottomEvent;
import qtc.project.pos_tablet.event.RequestLoginWithGoogleEvent;
import qtc.project.pos_tablet.fragment.account.forgot_password.FragmentForgotPassword;
import qtc.project.pos_tablet.fragment.account.password_manager.FragmentPasswordManager;
import qtc.project.pos_tablet.fragment.account.profile_manager.FragmentProfileManager;
import qtc.project.pos_tablet.fragment.account.register.FragmentRegister;
import qtc.project.pos_tablet.helper.Consts;
import qtc.project.pos_tablet.ui.views.action_bar.base_main_actionbar.BaseMainActionbarView;
import qtc.project.pos_tablet.ui.views.action_bar.base_main_actionbar.BaseMainActionbarViewCallback;
import qtc.project.pos_tablet.ui.views.action_bar.base_main_actionbar.BaseMainActionbarViewInterface;
import qtc.project.pos_tablet.ui.views.activity.base_main_activity.BaseMainActivityView;
import qtc.project.pos_tablet.ui.views.activity.base_main_activity.BaseMainActivityViewInterface;
import qtc.project.pos_tablet.ui.views.activity.home_activity.HomeActivityViewCallback;
