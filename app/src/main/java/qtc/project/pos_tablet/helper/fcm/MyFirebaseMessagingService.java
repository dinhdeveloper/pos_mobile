package qtc.project.pos_tablet.helper.fcm;
...
import qtc.project.pos_tablet.event.FroceSignoutEvent;
import qtc.project.pos_tablet.event.StatusEmployeeEvent;
import qtc.project.pos_tablet.helper.notification.NotificationUtils;
import qtc.project.pos_tablet.helper.notification.NotificationVO;
...
//                }
    ...
    private void handleNotification(RemoteMessage.Notification RemoteMsgNotification) {
        ...
        Intent resultIntent = new Intent(getApplicationContext(), HomeActivityBackup.class);
