...
public class SharePrefs {
    ...
    public void saveMap(String key , ListOrderModel obj) {
    ...
    public void saveKeyMap(Set<String> key){
        Set<String> set = new HashSet<String>();
        SharedPreferences.Editor scoreEditor = sharedPreferences.edit();
        set.addAll(key);
        scoreEditor.putStringSet(HashMap, set);
        scoreEditor.commit();
    }
    public Set<String> getKeyMap(){
        Set<String> set = new HashSet<String>();
        set = sharedPreferences.getStringSet(HashMap, null);
        return set;
    }

    public ListOrderModel getMap(String key) {
        Gson gson = new Gson();
        String json = sharedPreferences.getString(key,"");
        ListOrderModel obj = gson.fromJson(json, ListOrderModel.class);
        if (obj== null){return new ListOrderModel ();}
        return obj;
    }
    public void clearnKey(String key){
        save(key, null);
    }
